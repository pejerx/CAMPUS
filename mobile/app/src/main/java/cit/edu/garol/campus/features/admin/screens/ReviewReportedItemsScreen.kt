...
import cit.edu.garol.campus.features.admin.component.AdminReviewReportCard
...
fun ReviewReportedItemsScreen(
    ...
    val reportsUnderReview =
        uiState.reportedItems.filter {
        ...
        when {
            ...
            reportsUnderReview.isEmpty() -> {
                ...
                Box(
                    ...
                    Text(
                        text = "No reports awaiting review.",
