 ...
 */
@Generated
public class CampusApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new CampusApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new CampusApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
